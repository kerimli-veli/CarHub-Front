...
export default function Account() {
    ...
    const fetchUser = async () => {
      try {
        ...
        const response = await fetch(
          `https://carhubnewappapp-a2bxhke3hwe6gvg0.italynorth-01.azurewebsites.net/api/User/GetById?Id=${userInfo.id}`,
          {
            method: "GET",
            headers: {
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await fetch("https://carhubnewappapp-a2bxhke3hwe6gvg0.italynorth-01.azurewebsites.net/api/User/Update", {
        method: "PUT",
        headers: {
