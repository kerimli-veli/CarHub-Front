  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const response = await fetch(`https://carhubwebapp-cfbqhfawa9g9b4bh.italynorth-01.azurewebsites.net/api/User/GetById?Id=${user.id}`, {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    ...
    const fetchFavorites = async () => {
      try {
        ...
        const response = await fetch(`https://carhubwebapp-cfbqhfawa9g9b4bh.italynorth-01.azurewebsites.net/api/User/GetUserFavorites?UserId=${userId}`, {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${token}`,
            "Accept": "application/json",
